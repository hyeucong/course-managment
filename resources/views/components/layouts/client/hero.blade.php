    ...
    <div class="p-15 flex flex-col md:flex-row items-center justify-between w-full h-full">
        <div class="md:w-full text-left ">
            ...
            <button class="bg-black text-white py-3 px-6 rounded-md hover:bg-gray-800 focus:outline-none focus:ring-2
                focus:ring-black focus:ring-opacity-50">Get Started
            </button>
        </div>
        <div class="md:w-full">
            <div class="border rounded-lg shadow-md ring-1 ring-gray-200 bg-white">
                <div class="flex items-center space-x-2 p-3 border-b border-gray-200">
                    <div class="w-2.5 h-2.5 bg-gray-300 rounded-full"></div>
                    <div class="w-2.5 h-2.5 bg-gray-300 rounded-full"></div>
                    <div class="w-2.5 h-2.5 bg-gray-300 rounded-full"></div>
                </div>
                <div class="p-2">
                    <div class="h-100 bg-gray-50 rounded-md overflow-hidden">
                        <img class="object-center object-cover h-full w-full"
                            src="https://tkkcv3kpdu.ufs.sh/f/BG98G0XFP4rNEMT1xoeF27Ul0BMOrfY1WFnwm8DNaocPzvLp" alt="">
                    </div>
                </div>
            </div>
        </div>
